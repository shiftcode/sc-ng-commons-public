...
describe('timeFormat', () => {
  ...
  it('should format another time as HH:mm:ss.SSS', () => {
    const timestamp = new Date('2024-01-01T23:59:59.999Z')
    expect(loggingTimeFormat.format(timestamp)).toBe(`23:59:59.999`)
  })

  it('should format time with leading zeros as HH:mm:ss.SSS', () => {
